...
grant execute on function public.create_pos_order(uuid, uuid, uuid, uuid, text, jsonb) to authenticated;
grant execute on function public.create_pos_order(uuid, uuid, uuid, uuid, text, jsonb) to service_role;
